<%@ page language="java" import="java.util.*" pageEncoding="utf-8" import="zxing.code.*"%>
...
<body>
	...
	<form action="${pageContext.request.contextPath}/onlinePay"
		method="post">
		订单号：<INPUT TYPE="text" NAME="orderid" value="${param.id}" readonly="readonly">
	...
	<div> 
	  <a href="#" class="l" onclick="a()"><img src="E:\code\img.png"width="255px" height="255px" alt="an image" class="image" /></a>
	   <h2>支付宝支付请扫描</h2></div>
</body>
</html>
